...
const BACKEND_URL = 'http://YOUR_LOCAL_IP:5000'; // ⚠️ replace with your actual IP (hostname -I)
...
const styles = StyleSheet.create({
  ...
  locationBanner: {
    ...
    backgroundColor: AppColors.backgroundElement, borderRadius: 16,
  ...
  ring: {
    ...
    backgroundColor: 'rgba(229, 72, 77, 0.15)', alignItems: 'center', justifyContent: 'center',
  },
  circle: {
    width: CIRCLE_SIZE, height: CIRCLE_SIZE, borderRadius: CIRCLE_SIZE / 2,
    backgroundColor: AppColors.emergency, alignItems: 'center', justifyContent: 'center', gap: 4,
  },
  ...
  resultBanner: {
    marginTop: Spacing.four, paddingVertical: Spacing.two, paddingHorizontal: Spacing.three,
    borderRadius: 16, borderWidth: 1, maxWidth: 300,
  },
